    ...
    <script type="text/javascript">
        ...
        function loadInfo(info) {
            ...
            for ( var i = 0; i < 5; i++) {
                ...
                if(i < info.length) {
                    tds[0].innerHTML = "<input type='checkbox' onclick='_select(" + (5 * curPage + i) + ")'>";

                    if (selection[curPage * 5 + i] == 0)
                        tds[0].getElementsByTagName("input")[0].checked = false;
                    else
                        tds[0].getElementsByTagName("input")[0].checked = true;

                    tds[1].innerHTML = i + 1 + curPage * 5;
                    tds[2].innerHTML = info[i].name;
                    tds[3].innerHTML = info[i].count;
                    var d = new Date();
                    d.setTime(info[i].modifyTime);
                    tds[4].innerHTML = d.toLocaleString();
                    tds[5].innerHTML = '<button class="pull-right btn btn-primary btn-ms" style="margin-right: 60px" onclick="viewLib(' +  info[i].id + ')">查看详情</button>';
                } else {
                    for (var j = 0; j < 6; j++) {
                        tds[j].innerHTML = "";
                    }
        ...
        function  viewLib(i) {
            window.location.href = "questions?lid=" + i;
        }

        function add() {
            window.location.href = "libAdd?cid=" + cid;
        }
    ...
    <div id="students"
        ...
        <table class="table table-striped" id="libInfo">
            ...
            <tr>
                ...
                <th style='text-align: center;'>试题数</th>
